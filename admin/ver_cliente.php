...
<body>
	...
	<thead>
	<tr>
		<td>Link Cliente 1</td>
		<td>Link Cliente 2</td>
		<td>Link Cliente 3</td>
	</tr>
	</thead>
	<tbody>
	<?php 
	while($res = mysqli_fetch_array($result)) { 		
		echo "<tr>";
		echo "<td>".$res['link_cliente_1']."</td>";
		echo "<td>".$res['link_cliente_2']."</td>";
		echo "<td>".$res['link_cliente_3']."</td>";
		echo "<td><a href=\"editar_cliente.php?id=1\">Editar</a></td>";		
	}
	?>
	</tbody>
	</table>
