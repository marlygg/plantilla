...
<body>
	...
	while($res = mysqli_fetch_array($result)) { 		
		echo "<tr>";
		echo '<td><img  class="img-responsive" src="../assets/'.$res['favicon'].'"></td>';
		echo '<td><img  class="img-responsive" src="../assets/'.$res['logo'].'"></td>';
		echo "<td>".$res['autor']."</td>";
		echo "<td>".$res['facebook']."</td>";
		echo "<td>".$res['ip_servidor']."</td>";
		echo "<td><a href=\"editar_principal.php?id=1\">Editar</a></td>";		
	}
	?>
	</tbody>
	</table>
