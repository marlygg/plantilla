...
<body>
	...
	while($res = mysqli_fetch_array($result)) { 		
		echo "<tr>";
		echo "<td>".$res['menu1']."</td>";
		echo "<td>".$res['menu2']."</td>";
		echo "<td>".$res['menu3']."</td>";
		echo "<td>".$res['menu4']."</td>";
		echo "<td>".$res['menu5']."</td>";
		echo "<td>".$res['menu6']."</td>";
		echo "<td>".$res['menu7']."</td>";
		echo "<td><a href=\"editar_menu.php?id=1\">Editar</a></td>";		
	}
	?>
	</tbody>
	</table>
