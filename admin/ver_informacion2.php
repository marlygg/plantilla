...
<body>
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td>".$res['icono_2']."</td>";
		echo "<td>".$res['titulo_icono_2']."</td>";
		echo "<td>".$res['desc_icono_2']."</td>";
		echo "<td><a href=\"editar_informacion2.php?id=1\">Editar</a></td>";		
	}
	?>
	</tbody>
	</table>
